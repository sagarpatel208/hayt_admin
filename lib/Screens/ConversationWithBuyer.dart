...
class ConversationWithBuyer extends StatefulWidget {
  String adminId, buyerId;

  ConversationWithBuyer(this.adminId, this.buyerId);

  @override
  _ConversationWithBuyerState createState() => _ConversationWithBuyerState();
}

class _ConversationWithBuyerState extends State<ConversationWithBuyer> {
  ...
  void initState() {
    ...
    print("a: ${widget.adminId}, b: ${widget.buyerId}");
    GetChatMsg();
  }
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        FormData data = FormData.fromMap(
            {"adminid": widget.adminId, "userid": widget.buyerId});
  ...
  _sendMessage() async {
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        print("s: ${edtMessage.text} ${widget.adminId} ${widget.buyerId}");
