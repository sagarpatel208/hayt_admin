          ...
          : _shops.length > 0
              ? ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ShopsComponents(_shops[index]);
                  })
              : Center(
...
class ShopsComponents extends StatefulWidget {
  var _shop;
  ShopsComponents(this._shop);
  @override
  _ShopsComponentsState createState() => _ShopsComponentsState();
}

class _ShopsComponentsState extends State<ShopsComponents> {
  ProgressDialog pr;
  @override
  void initState() {
  ...
  _activateShop() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        AppServices.UpdateShopStatus(widget._shop["id"], data).then(
            (data) async {
          pr.hide();
          if (data.data == "0") {
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Expanded(child: Text("${widget._shop["shopname"]}")),
